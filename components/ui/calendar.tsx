  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium flex p-1 ",
        nav: "space-x-1 flex items-center ",
        button_previous: cn(
          buttonVariants({ variant: "outline" }),
          "absolute left-9 top-3 h-7 w-7 bg-transparent text-orange-500 p-0 opacity-50 hover:opacity-100"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "absolute right-9 top-3 h-7 w-7 bg-transparent text-orange-500 p-0 opacity-50 hover:opacity-100"
        ),
